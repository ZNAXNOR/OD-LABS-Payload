...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_sect_right_layout" AS ENUM('stack', 'grid');
  CREATE TYPE "public"."art_sel" AS ENUM('stackList', 'processFlow', 'codeSnippet', 'ad');
  CREATE TYPE "public"."enum_pages_blocks_archive_variant" AS ENUM('default', 'servicesGrid', 'artifact');
  ...
  CREATE TYPE "public"."enum_pages_blocks_archive_artifact_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_ab_art_pf_steps_icon" AS ENUM('none', 'GitCommitHorizontal', 'FlaskConical', 'Rocket');
  CREATE TYPE "public"."enum_ab_sect_layout" AS ENUM('row', 'columns', 'split');
  CREATE TYPE "public"."enum_ab_sect_variant" AS ENUM('primary', 'secondary', 'highlight');
  CREATE TYPE "public"."enum_ab_sect_right_layout" AS ENUM('stack', 'grid');
  ...
  CREATE TYPE "public"."ab_art_sel" AS ENUM('stackList', 'processFlow', 'codeSnippet', 'ad');
  ...
  CREATE TYPE "public"."enum_pages_blocks_comparison_item_style" AS ENUM('icon', 'bulletPoints');
  ...
  CREATE TYPE "public"."enum_pages_blocks_form_block_variant" AS ENUM('default', 'contact');
  CREATE TYPE "public"."enum_pages_blocks_process_block_variant" AS ENUM('journey', 'numberedPanels');
  CREATE TYPE "public"."enum_pages_blocks_process_step_shape" AS ENUM('circle', 'rectangle');
  CREATE TYPE "public"."enum_ss_art_pf_steps_icon" AS ENUM('none', 'GitCommitHorizontal', 'FlaskConical', 'Rocket');
  CREATE TYPE "public"."enum_ss_sect_layout" AS ENUM('row', 'columns', 'split');
  CREATE TYPE "public"."enum_ss_sect_variant" AS ENUM('primary', 'secondary', 'highlight');
  CREATE TYPE "public"."enum_ss_sect_right_layout" AS ENUM('stack', 'grid');
  ...
  CREATE TYPE "public"."ss_art_sel" AS ENUM('stackList', 'processFlow', 'codeSnippet', 'ad');
  ...
  CREATE TYPE "public"."enum__sect_v_right_layout" AS ENUM('stack', 'grid');
  CREATE TYPE "public"."enum__pages_v_blocks_archive_variant" AS ENUM('default', 'servicesGrid', 'artifact');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_archive_artifact_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum__ab_art_pf_steps_v_icon" AS ENUM('none', 'GitCommitHorizontal', 'FlaskConical', 'Rocket');
  CREATE TYPE "public"."enum__ab_sect_v_layout" AS ENUM('row', 'columns', 'split');
  CREATE TYPE "public"."enum__ab_sect_v_variant" AS ENUM('primary', 'secondary', 'highlight');
  CREATE TYPE "public"."enum__ab_sect_v_right_layout" AS ENUM('stack', 'grid');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_comparison_item_style" AS ENUM('icon', 'bulletPoints');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_form_block_variant" AS ENUM('default', 'contact');
  CREATE TYPE "public"."enum__pages_v_blocks_process_block_variant" AS ENUM('journey', 'numberedPanels');
  CREATE TYPE "public"."enum__pages_v_blocks_process_step_shape" AS ENUM('circle', 'rectangle');
  CREATE TYPE "public"."enum__ss_art_pf_steps_v_icon" AS ENUM('none', 'GitCommitHorizontal', 'FlaskConical', 'Rocket');
  CREATE TYPE "public"."enum__ss_sect_v_layout" AS ENUM('row', 'columns', 'split');
  CREATE TYPE "public"."enum__ss_sect_v_variant" AS ENUM('primary', 'secondary', 'highlight');
  CREATE TYPE "public"."enum__ss_sect_v_right_layout" AS ENUM('stack', 'grid');
  ...
  CREATE TABLE "sect" (
  	...
  	"variant" "enum_sect_variant" DEFAULT 'secondary',
  	"right_layout" "enum_sect_right_layout" DEFAULT 'stack'
  );
  
  CREATE TABLE "pages_blocks_archive_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"archive_id" integer,
  ...
  CREATE TABLE "pages_blocks_archive" (
  	...
  	"artifact_eyebrow" varchar DEFAULT 'Operational Evidence',
  	"artifact_heading" varchar DEFAULT 'Engineering Decisions Backed By Real Artifacts',
  	"artifact_intro" jsonb,
  	"artifact_link_type" "enum_pages_blocks_archive_artifact_link_type" DEFAULT 'reference',
  	"artifact_link_new_tab" boolean,
  	"artifact_link_url" varchar,
  	"artifact_link_label" varchar DEFAULT 'View all technical notes',
  	"block_name" varchar
  );
  
  CREATE TABLE "ab_art_sl_rows" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"label" varchar,
  ...
  CREATE TABLE "ab_art_pf_steps" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"label" varchar,
  	"icon" "enum_ab_art_pf_steps_icon" DEFAULT 'none',
  	"highlight" boolean DEFAULT false
  );
  
  CREATE TABLE "ab_sect_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"label" varchar
  ...
  CREATE TABLE "ab_sect" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"layout" "enum_ab_sect_layout",
  	"variant" "enum_ab_sect_variant" DEFAULT 'secondary',
  	"right_layout" "enum_ab_sect_right_layout" DEFAULT 'stack'
  );
  ...
  CREATE TABLE "pages_blocks_comparison" (
  	...
  	"item_style" "enum_pages_blocks_comparison_item_style" DEFAULT 'icon',
  	"eyebrow" varchar,
  	"heading" varchar,
  	"left_title" varchar,
  	"right_title" varchar,
  ...
  CREATE TABLE "pages_blocks_form_block_trust_panel_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"icon" varchar,
  ...
  CREATE TABLE "pages_blocks_form_block" (
  	...
  	"intro_content" jsonb,
  	"trust_panel_heading" varchar,
  	"trust_panel_email" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "pages_blocks_process" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"block_variant" "enum_pages_blocks_process_block_variant" DEFAULT 'journey',
  	"eyebrow" varchar,
  	"heading" varchar,
  	"step_shape" "enum_pages_blocks_process_step_shape" DEFAULT 'circle',
  	"block_name" varchar
  );
  
  CREATE TABLE "ss_art_sl_rows" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"label" varchar,
  ...
  CREATE TABLE "ss_art_pf_steps" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"label" varchar,
  	"icon" "enum_ss_art_pf_steps_icon" DEFAULT 'none',
  	"highlight" boolean DEFAULT false
  );
  
  CREATE TABLE "ss_sect_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"label" varchar
  ...
  CREATE TABLE "ss_sect" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"layout" "enum_ss_sect_layout",
  	"variant" "enum_ss_sect_variant" DEFAULT 'secondary',
  	"right_layout" "enum_ss_sect_right_layout" DEFAULT 'stack'
  );
  ...
  CREATE TABLE "_sect_v" (
  	...
  	"variant" "enum__sect_v_variant" DEFAULT 'secondary',
  	"right_layout" "enum__sect_v_right_layout" DEFAULT 'stack',
  	"_uuid" varchar
  );
  
  CREATE TABLE "_pages_v_blocks_archive_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"archive_id" integer,
  ...
  CREATE TABLE "_pages_v_blocks_archive" (
  	...
  	"artifact_heading" varchar DEFAULT 'Engineering Decisions Backed By Real Artifacts',
  	"artifact_intro" jsonb,
  	"artifact_link_type" "enum__pages_v_blocks_archive_artifact_link_type" DEFAULT 'reference',
  	"artifact_link_new_tab" boolean,
  	"artifact_link_url" varchar,
  	"artifact_link_label" varchar DEFAULT 'View all technical notes',
  	"_uuid" varchar,
  ...
  CREATE TABLE "_ab_art_sl_rows_v" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"label" varchar,
  ...
  CREATE TABLE "_ab_art_pf_steps_v" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"label" varchar,
  	"icon" "enum__ab_art_pf_steps_v_icon" DEFAULT 'none',
  	"highlight" boolean DEFAULT false,
  	"_uuid" varchar
  );
  
  CREATE TABLE "_ab_sect_v_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"label" varchar,
  ...
  CREATE TABLE "_ab_sect_v" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"layout" "enum__ab_sect_v_layout",
  	"variant" "enum__ab_sect_v_variant" DEFAULT 'secondary',
  	"right_layout" "enum__ab_sect_v_right_layout" DEFAULT 'stack',
  	"_uuid" varchar
  );
  ...
  CREATE TABLE "_pages_v_blocks_comparison" (
  	...
  	"item_style" "enum__pages_v_blocks_comparison_item_style" DEFAULT 'icon',
  	"eyebrow" varchar,
  	"heading" varchar,
  	"left_title" varchar,
  	"right_title" varchar,
  ...
  CREATE TABLE "_pages_v_blocks_form_block_trust_panel_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"icon" varchar,
  ...
  CREATE TABLE "_pages_v_blocks_process" (
  	...
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"block_variant" "enum__pages_v_blocks_process_block_variant" DEFAULT 'journey',
  	"eyebrow" varchar,
  	"heading" varchar,
  	"step_shape" "enum__pages_v_blocks_process_step_shape" DEFAULT 'circle',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  
  CREATE TABLE "_ss_art_sl_rows_v" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"label" varchar,
  ...
  CREATE TABLE "_ss_art_pf_steps_v" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"label" varchar,
  	"icon" "enum__ss_art_pf_steps_v_icon" DEFAULT 'none',
  	"highlight" boolean DEFAULT false,
  	"_uuid" varchar
  );
  
  CREATE TABLE "_ss_sect_v_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"label" varchar,
  ...
  CREATE TABLE "_ss_sect_v" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"layout" "enum__ss_sect_v_layout",
  	"variant" "enum__ss_sect_v_variant" DEFAULT 'secondary',
  	"right_layout" "enum__ss_sect_v_right_layout" DEFAULT 'stack',
  	"_uuid" varchar
  );
  ...
  ALTER TABLE "art_sl_rows" ADD CONSTRAINT "art_sl_rows_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_archive_items"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "art_pf_steps" ADD CONSTRAINT "art_pf_steps_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_archive_items"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "sect" ADD CONSTRAINT "sect_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_archive_items"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_archive_items" ADD CONSTRAINT "pages_blocks_archive_items_archive_id_posts_id_fk" FOREIGN KEY ("archive_id") REFERENCES "public"."posts"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "pages_blocks_archive_items" ADD CONSTRAINT "pages_blocks_archive_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_archive"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_archive" ADD CONSTRAINT "pages_blocks_archive_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "ab_art_sl_rows" ADD CONSTRAINT "ab_art_sl_rows_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_artifact_block_items"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "ab_art_pf_steps" ADD CONSTRAINT "ab_art_pf_steps_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_artifact_block_items"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "ab_sect_items" ADD CONSTRAINT "ab_sect_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."ab_sect"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "ab_sect_left" ADD CONSTRAINT "ab_sect_left_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."ab_sect"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "ab_sect_right" ADD CONSTRAINT "ab_sect_right_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."ab_sect"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "ab_sect" ADD CONSTRAINT "ab_sect_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_artifact_block_items"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "pages_blocks_form_block_trust_panel_items" ADD CONSTRAINT "pages_blocks_form_block_trust_panel_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_form_block"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "ss_art_sl_rows" ADD CONSTRAINT "ss_art_sl_rows_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_service_showcase_items"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "ss_art_pf_steps" ADD CONSTRAINT "ss_art_pf_steps_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_service_showcase_items"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "ss_sect_items" ADD CONSTRAINT "ss_sect_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."ss_sect"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "ss_sect_left" ADD CONSTRAINT "ss_sect_left_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."ss_sect"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "ss_sect_right" ADD CONSTRAINT "ss_sect_right_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."ss_sect"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "ss_sect" ADD CONSTRAINT "ss_sect_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_service_showcase_items"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_art_sl_rows_v" ADD CONSTRAINT "_art_sl_rows_v_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_archive_items"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_art_pf_steps_v" ADD CONSTRAINT "_art_pf_steps_v_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_archive_items"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_sect_v" ADD CONSTRAINT "_sect_v_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_archive_items"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_archive_items" ADD CONSTRAINT "_pages_v_blocks_archive_items_archive_id_posts_id_fk" FOREIGN KEY ("archive_id") REFERENCES "public"."posts"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_archive_items" ADD CONSTRAINT "_pages_v_blocks_archive_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_archive"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_archive" ADD CONSTRAINT "_pages_v_blocks_archive_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_ab_art_sl_rows_v" ADD CONSTRAINT "_ab_art_sl_rows_v_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_artifact_block_items"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_ab_art_pf_steps_v" ADD CONSTRAINT "_ab_art_pf_steps_v_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_artifact_block_items"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_ab_sect_v_items" ADD CONSTRAINT "_ab_sect_v_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_ab_sect_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_ab_sect_v_left" ADD CONSTRAINT "_ab_sect_v_left_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_ab_sect_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_ab_sect_v_right" ADD CONSTRAINT "_ab_sect_v_right_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_ab_sect_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_ab_sect_v" ADD CONSTRAINT "_ab_sect_v_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_artifact_block_items"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_form_block_trust_panel_items" ADD CONSTRAINT "_pages_v_blocks_form_block_trust_panel_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_form_block"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_ss_art_sl_rows_v" ADD CONSTRAINT "_ss_art_sl_rows_v_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_service_showcase_items"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_ss_art_pf_steps_v" ADD CONSTRAINT "_ss_art_pf_steps_v_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_service_showcase_items"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_ss_sect_v_items" ADD CONSTRAINT "_ss_sect_v_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_ss_sect_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_ss_sect_v_left" ADD CONSTRAINT "_ss_sect_v_left_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_ss_sect_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_ss_sect_v_right" ADD CONSTRAINT "_ss_sect_v_right_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_ss_sect_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_ss_sect_v" ADD CONSTRAINT "_ss_sect_v_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_service_showcase_items"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_archive_items_order_idx" ON "pages_blocks_archive_items" USING btree ("_order");
  CREATE INDEX "pages_blocks_archive_items_parent_id_idx" ON "pages_blocks_archive_items" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_archive_items_archive_idx" ON "pages_blocks_archive_items" USING btree ("archive_id");
  CREATE INDEX "pages_blocks_archive_order_idx" ON "pages_blocks_archive" USING btree ("_order");
  CREATE INDEX "pages_blocks_archive_parent_id_idx" ON "pages_blocks_archive" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_archive_path_idx" ON "pages_blocks_archive" USING btree ("_path");
  CREATE INDEX "ab_art_sl_rows_order_idx" ON "ab_art_sl_rows" USING btree ("_order");
  CREATE INDEX "ab_art_sl_rows_parent_id_idx" ON "ab_art_sl_rows" USING btree ("_parent_id");
  CREATE INDEX "ab_art_pf_steps_order_idx" ON "ab_art_pf_steps" USING btree ("_order");
  CREATE INDEX "ab_art_pf_steps_parent_id_idx" ON "ab_art_pf_steps" USING btree ("_parent_id");
  CREATE INDEX "ab_sect_items_order_idx" ON "ab_sect_items" USING btree ("_order");
  CREATE INDEX "ab_sect_items_parent_id_idx" ON "ab_sect_items" USING btree ("_parent_id");
  CREATE INDEX "ab_sect_left_order_idx" ON "ab_sect_left" USING btree ("_order");
  CREATE INDEX "ab_sect_left_parent_id_idx" ON "ab_sect_left" USING btree ("_parent_id");
  CREATE INDEX "ab_sect_right_order_idx" ON "ab_sect_right" USING btree ("_order");
  CREATE INDEX "ab_sect_right_parent_id_idx" ON "ab_sect_right" USING btree ("_parent_id");
  CREATE INDEX "ab_sect_order_idx" ON "ab_sect" USING btree ("_order");
  CREATE INDEX "ab_sect_parent_id_idx" ON "ab_sect" USING btree ("_parent_id");
  ...
  CREATE INDEX "pages_blocks_form_block_trust_panel_items_order_idx" ON "pages_blocks_form_block_trust_panel_items" USING btree ("_order");
  CREATE INDEX "pages_blocks_form_block_trust_panel_items_parent_id_idx" ON "pages_blocks_form_block_trust_panel_items" USING btree ("_parent_id");
  ...
  CREATE INDEX "ss_art_sl_rows_order_idx" ON "ss_art_sl_rows" USING btree ("_order");
  CREATE INDEX "ss_art_sl_rows_parent_id_idx" ON "ss_art_sl_rows" USING btree ("_parent_id");
  CREATE INDEX "ss_art_pf_steps_order_idx" ON "ss_art_pf_steps" USING btree ("_order");
  CREATE INDEX "ss_art_pf_steps_parent_id_idx" ON "ss_art_pf_steps" USING btree ("_parent_id");
  CREATE INDEX "ss_sect_items_order_idx" ON "ss_sect_items" USING btree ("_order");
  CREATE INDEX "ss_sect_items_parent_id_idx" ON "ss_sect_items" USING btree ("_parent_id");
  CREATE INDEX "ss_sect_left_order_idx" ON "ss_sect_left" USING btree ("_order");
  CREATE INDEX "ss_sect_left_parent_id_idx" ON "ss_sect_left" USING btree ("_parent_id");
  CREATE INDEX "ss_sect_right_order_idx" ON "ss_sect_right" USING btree ("_order");
  CREATE INDEX "ss_sect_right_parent_id_idx" ON "ss_sect_right" USING btree ("_parent_id");
  CREATE INDEX "ss_sect_order_idx" ON "ss_sect" USING btree ("_order");
  CREATE INDEX "ss_sect_parent_id_idx" ON "ss_sect" USING btree ("_parent_id");
  ...
  CREATE INDEX "_pages_v_blocks_archive_items_order_idx" ON "_pages_v_blocks_archive_items" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_archive_items_parent_id_idx" ON "_pages_v_blocks_archive_items" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_archive_items_archive_idx" ON "_pages_v_blocks_archive_items" USING btree ("archive_id");
  CREATE INDEX "_pages_v_blocks_archive_order_idx" ON "_pages_v_blocks_archive" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_archive_parent_id_idx" ON "_pages_v_blocks_archive" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_archive_path_idx" ON "_pages_v_blocks_archive" USING btree ("_path");
  CREATE INDEX "_ab_art_sl_rows_v_order_idx" ON "_ab_art_sl_rows_v" USING btree ("_order");
  CREATE INDEX "_ab_art_sl_rows_v_parent_id_idx" ON "_ab_art_sl_rows_v" USING btree ("_parent_id");
  CREATE INDEX "_ab_art_pf_steps_v_order_idx" ON "_ab_art_pf_steps_v" USING btree ("_order");
  CREATE INDEX "_ab_art_pf_steps_v_parent_id_idx" ON "_ab_art_pf_steps_v" USING btree ("_parent_id");
  CREATE INDEX "_ab_sect_v_items_order_idx" ON "_ab_sect_v_items" USING btree ("_order");
  CREATE INDEX "_ab_sect_v_items_parent_id_idx" ON "_ab_sect_v_items" USING btree ("_parent_id");
  CREATE INDEX "_ab_sect_v_left_order_idx" ON "_ab_sect_v_left" USING btree ("_order");
  CREATE INDEX "_ab_sect_v_left_parent_id_idx" ON "_ab_sect_v_left" USING btree ("_parent_id");
  CREATE INDEX "_ab_sect_v_right_order_idx" ON "_ab_sect_v_right" USING btree ("_order");
  CREATE INDEX "_ab_sect_v_right_parent_id_idx" ON "_ab_sect_v_right" USING btree ("_parent_id");
  CREATE INDEX "_ab_sect_v_order_idx" ON "_ab_sect_v" USING btree ("_order");
  CREATE INDEX "_ab_sect_v_parent_id_idx" ON "_ab_sect_v" USING btree ("_parent_id");
  ...
  CREATE INDEX "_pages_v_blocks_form_block_trust_panel_items_order_idx" ON "_pages_v_blocks_form_block_trust_panel_items" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_form_block_trust_panel_items_parent_id_idx" ON "_pages_v_blocks_form_block_trust_panel_items" USING btree ("_parent_id");
  ...
  CREATE INDEX "_ss_art_sl_rows_v_order_idx" ON "_ss_art_sl_rows_v" USING btree ("_order");
  CREATE INDEX "_ss_art_sl_rows_v_parent_id_idx" ON "_ss_art_sl_rows_v" USING btree ("_parent_id");
  CREATE INDEX "_ss_art_pf_steps_v_order_idx" ON "_ss_art_pf_steps_v" USING btree ("_order");
  CREATE INDEX "_ss_art_pf_steps_v_parent_id_idx" ON "_ss_art_pf_steps_v" USING btree ("_parent_id");
  CREATE INDEX "_ss_sect_v_items_order_idx" ON "_ss_sect_v_items" USING btree ("_order");
  CREATE INDEX "_ss_sect_v_items_parent_id_idx" ON "_ss_sect_v_items" USING btree ("_parent_id");
  CREATE INDEX "_ss_sect_v_left_order_idx" ON "_ss_sect_v_left" USING btree ("_order");
  CREATE INDEX "_ss_sect_v_left_parent_id_idx" ON "_ss_sect_v_left" USING btree ("_parent_id");
  CREATE INDEX "_ss_sect_v_right_order_idx" ON "_ss_sect_v_right" USING btree ("_order");
  CREATE INDEX "_ss_sect_v_right_parent_id_idx" ON "_ss_sect_v_right" USING btree ("_parent_id");
  CREATE INDEX "_ss_sect_v_order_idx" ON "_ss_sect_v" USING btree ("_order");
  CREATE INDEX "_ss_sect_v_parent_id_idx" ON "_ss_sect_v" USING btree ("_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_archive_items" CASCADE;
  DROP TABLE "pages_blocks_archive" CASCADE;
  DROP TABLE "ab_art_sl_rows" CASCADE;
  DROP TABLE "ab_art_pf_steps" CASCADE;
  DROP TABLE "ab_sect_items" CASCADE;
  DROP TABLE "ab_sect_left" CASCADE;
  DROP TABLE "ab_sect_right" CASCADE;
  DROP TABLE "ab_sect" CASCADE;
  ...
  DROP TABLE "pages_blocks_form_block_trust_panel_items" CASCADE;
  ...
  DROP TABLE "ss_art_sl_rows" CASCADE;
  DROP TABLE "ss_art_pf_steps" CASCADE;
  DROP TABLE "ss_sect_items" CASCADE;
  DROP TABLE "ss_sect_left" CASCADE;
  DROP TABLE "ss_sect_right" CASCADE;
  DROP TABLE "ss_sect" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_archive_items" CASCADE;
  DROP TABLE "_pages_v_blocks_archive" CASCADE;
  DROP TABLE "_ab_art_sl_rows_v" CASCADE;
  DROP TABLE "_ab_art_pf_steps_v" CASCADE;
  DROP TABLE "_ab_sect_v_items" CASCADE;
  DROP TABLE "_ab_sect_v_left" CASCADE;
  DROP TABLE "_ab_sect_v_right" CASCADE;
  DROP TABLE "_ab_sect_v" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_form_block_trust_panel_items" CASCADE;
  ...
  DROP TABLE "_ss_art_sl_rows_v" CASCADE;
  DROP TABLE "_ss_art_pf_steps_v" CASCADE;
  DROP TABLE "_ss_sect_v_items" CASCADE;
  DROP TABLE "_ss_sect_v_left" CASCADE;
  DROP TABLE "_ss_sect_v_right" CASCADE;
  DROP TABLE "_ss_sect_v" CASCADE;
  ...
  DROP TYPE "public"."enum_sect_right_layout";
  ...
  DROP TYPE "public"."enum_pages_blocks_archive_artifact_link_type";
  DROP TYPE "public"."enum_ab_art_pf_steps_icon";
  DROP TYPE "public"."enum_ab_sect_layout";
  DROP TYPE "public"."enum_ab_sect_variant";
  DROP TYPE "public"."enum_ab_sect_right_layout";
  DROP TYPE "public"."enum_pages_blocks_artifact_block_items_icon";
  DROP TYPE "public"."wd";
  DROP TYPE "public"."ab_art_sel";
  ...
  DROP TYPE "public"."enum_pages_blocks_comparison_item_style";
  ...
  DROP TYPE "public"."enum_pages_blocks_process_block_variant";
  DROP TYPE "public"."enum_pages_blocks_process_step_shape";
  DROP TYPE "public"."enum_ss_art_pf_steps_icon";
  DROP TYPE "public"."enum_ss_sect_layout";
  DROP TYPE "public"."enum_ss_sect_variant";
  DROP TYPE "public"."enum_ss_sect_right_layout";
  ...
  DROP TYPE "public"."enum__sect_v_right_layout";
  ...
  DROP TYPE "public"."enum__pages_v_blocks_archive_artifact_link_type";
  DROP TYPE "public"."enum__ab_art_pf_steps_v_icon";
  DROP TYPE "public"."enum__ab_sect_v_layout";
  DROP TYPE "public"."enum__ab_sect_v_variant";
  DROP TYPE "public"."enum__ab_sect_v_right_layout";
  ...
  DROP TYPE "public"."enum__pages_v_blocks_comparison_item_style";
  ...
  DROP TYPE "public"."enum__pages_v_blocks_process_block_variant";
  DROP TYPE "public"."enum__pages_v_blocks_process_step_shape";
  DROP TYPE "public"."enum__ss_art_pf_steps_v_icon";
  DROP TYPE "public"."enum__ss_sect_v_layout";
  DROP TYPE "public"."enum__ss_sect_v_variant";
  DROP TYPE "public"."enum__ss_sect_v_right_layout";
