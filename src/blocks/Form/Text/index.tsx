    ...
    <Width width={width}>
      <div className="relative z-0 transition-all focus-within:z-10">
        <input
          ...
          placeholder=" "
          className="peer block w-full border border-neutral-300 dark:border-neutral-700 bg-transparent px-6 pt-12 pb-4 text-base/6 transition group-first:rounded-t-2xl group-last:rounded-b-2xl"
