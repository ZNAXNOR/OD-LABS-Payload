...
// Define the type locally since it might not be in payload-types yet
    ...
    <section className="max-w-7xl mx-auto px-8 py-20 bg-neutral-800 text-white rounded-3xl">
      ...
      {note && (
        <div className="mt-16 pt-12 border-t border-gray-700 text-center space-y-4">
          <RichText data={note} enableGutter={false} className="text-gray-400 italic max-w-2xl mx-auto prose-invert prose-strong:text-gray-300" />
        </div>
      )}
      </div>
    </section>
