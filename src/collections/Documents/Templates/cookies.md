...
- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Cookies Policy) refers to {{companyName}}, {{companyAddress}}.
...
- __Website__ refers to OD LABS, accessible from [{{websiteUrl}}]({{websiteUrl}})
...
- By email: [{{companyEmail}}](mailto:{{companyEmail}})


- By visiting this page on our website: [{{websiteUrl}}/contact]({{websiteUrl}}/contact)