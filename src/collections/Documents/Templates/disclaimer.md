...
- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Disclaimer) refers to {{companyName}}, {{companyAddress}}.
...
- __Website__ refers to {{companyName}}, accessible from [{{websiteUrl}}](https://odtechlab.com)
...
- By email: sent@odtechlab.com


- By visiting this page on our website: [https://odtechlab.com/contact](https://odtechlab.com/contact)