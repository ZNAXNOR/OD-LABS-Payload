...
export const enum_pages_blocks_content_columns_accent_line_alignment = pgEnum(
  'enum_pages_blocks_content_columns_accent_line_alignment',
  ['left', 'right'],
)
...
export const enum_pages_blocks_content_rows_padding_top = pgEnum(
  'enum_pages_blocks_content_rows_padding_top',
  ['small', 'medium', 'large'],
)
export const enum_pages_blocks_content_rows_padding_bottom = pgEnum(
  'enum_pages_blocks_content_rows_padding_bottom',
  ['small', 'medium', 'large'],
)
...
export const enum__pages_v_blocks_content_columns_alignment = pgEnum(
  'enum__pages_v_blocks_content_columns_alignment',
  ['left', 'center', 'right'],
)
export const enum__pages_v_blocks_content_columns_accent_line_alignment = pgEnum(
  'enum__pages_v_blocks_content_columns_accent_line_alignment',
  ['left', 'right'],
)
...
export const enum__pages_v_blocks_content_rows_padding_top = pgEnum(
  'enum__pages_v_blocks_content_rows_padding_top',
  ['small', 'medium', 'large'],
)
export const enum__pages_v_blocks_content_rows_padding_bottom = pgEnum(
  'enum__pages_v_blocks_content_rows_padding_bottom',
  ['small', 'medium', 'large'],
)
...
export const enum_mega_menu_nav_items_link_type = pgEnum('enum_mega_menu_nav_items_link_type', [
  'reference',
  'custom',
])
...
export const pages_blocks_cta = pgTable(
  'pages_blocks_cta',
  {
    ...
    id: varchar('id').primaryKey(),
    backgroundColor: enum_pages_blocks_cta_background_color('background_color').default('none'),
...
export const pages_blocks_content_columns = pgTable(
  'pages_blocks_content_columns',
  {
    ...
    alignment: enum_pages_blocks_content_columns_alignment('alignment').default('left'),
    accentLine: boolean('accent_line').default(false),
    accentLineAlignment:
      enum_pages_blocks_content_columns_accent_line_alignment('accent_line_alignment').default(
        'left',
      ),
    backgroundColor:
      enum_pages_blocks_content_columns_background_color('background_color').default('none'),
    richText: jsonb('rich_text'),
...
export const pages_blocks_content_rows = pgTable(
  'pages_blocks_content_rows',
  {
    _order: integer('_order').notNull(),
    _parentID: varchar('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
    paddingTop: enum_pages_blocks_content_rows_padding_top('padding_top').default('medium'),
    paddingBottom:
      enum_pages_blocks_content_rows_padding_bottom('padding_bottom').default('medium'),
  },
  (columns) => [
    index('pages_blocks_content_rows_order_idx').on(columns._order),
    index('pages_blocks_content_rows_parent_id_idx').on(columns._parentID),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages_blocks_content.id],
      name: 'pages_blocks_content_rows_parent_id_fk',
    }).onDelete('cascade'),
  ],
)
...
export const _pages_v_blocks_cta = pgTable(
  '_pages_v_blocks_cta',
  {
    ...
    _path: text('_path').notNull(),
    id: serial('id').primaryKey(),
    backgroundColor: enum__pages_v_blocks_cta_background_color('background_color').default('none'),
    richText: jsonb('rich_text'),
    _uuid: varchar('_uuid'),
    blockName: varchar('block_name'),
  },
...
export const _pages_v_blocks_content_columns = pgTable(
  '_pages_v_blocks_content_columns',
  {
    ...
    alignment: enum__pages_v_blocks_content_columns_alignment('alignment').default('left'),
    accentLine: boolean('accent_line').default(false),
    accentLineAlignment:
      enum__pages_v_blocks_content_columns_accent_line_alignment('accent_line_alignment').default(
        'left',
      ),
    backgroundColor:
      enum__pages_v_blocks_content_columns_background_color('background_color').default('none'),
    richText: jsonb('rich_text'),
    enableLink: boolean('enable_link'),
...
export const _pages_v_blocks_content_rows = pgTable(
  '_pages_v_blocks_content_rows',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
    paddingTop: enum__pages_v_blocks_content_rows_padding_top('padding_top').default('medium'),
    paddingBottom:
      enum__pages_v_blocks_content_rows_padding_bottom('padding_bottom').default('medium'),
    _uuid: varchar('_uuid'),
  },
  (columns) => [
    index('_pages_v_blocks_content_rows_order_idx').on(columns._order),
    index('_pages_v_blocks_content_rows_parent_id_idx').on(columns._parentID),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v_blocks_content.id],
      name: '_pages_v_blocks_content_rows_parent_id_fk',
    }).onDelete('cascade'),
  ],
)
...
export const studies = pgTable(
  ...
  (columns) => [
    index('studies_featured_image_idx').on(columns.featuredImage),
    uniqueIndex('studies_slug_idx').on(columns.slug),
    index('studies_updated_at_idx').on(columns.updatedAt),
    index('studies_created_at_idx').on(columns.createdAt),
  ],
)
...
export const studies_rels = pgTable(
  ...
  (columns) => [
    index('studies_rels_order_idx').on(columns.order),
    index('studies_rels_parent_idx').on(columns.parent),
    index('studies_rels_path_idx').on(columns.path),
    index('studies_rels_categories_id_idx').on(columns.categoriesID),
    foreignKey({
      columns: [columns['parent']],
...
export const payload_locked_documents_rels = pgTable(
  ...
  (columns) => [
    ...
    index('payload_locked_documents_rels_studies_id_idx').on(columns.studiesID),
...
export const mega_menu_nav_items = pgTable(
  'mega_menu_nav_items',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
    link_type: enum_mega_menu_nav_items_link_type('link_type').default('reference'),
    link_newTab: boolean('link_new_tab'),
    link_url: varchar('link_url'),
    link_label: varchar('link_label').notNull(),
  },
  (columns) => [
    index('mega_menu_nav_items_order_idx').on(columns._order),
    index('mega_menu_nav_items_parent_id_idx').on(columns._parentID),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [mega_menu.id],
      name: 'mega_menu_nav_items_parent_id_fk',
    }).onDelete('cascade'),
  ],
)
...
export const mega_menu_rels = pgTable(
  'mega_menu_rels',
  {
    id: serial('id').primaryKey(),
    order: integer('order'),
  ...
  (columns) => [
    index('mega_menu_rels_order_idx').on(columns.order),
    index('mega_menu_rels_parent_idx').on(columns.parent),
    index('mega_menu_rels_path_idx').on(columns.path),
    index('mega_menu_rels_pages_id_idx').on(columns.pagesID),
    index('mega_menu_rels_posts_id_idx').on(columns.postsID),
    foreignKey({
      columns: [columns['parent']],
      foreignColumns: [mega_menu.id],
      name: 'mega_menu_rels_parent_fk',
    }).onDelete('cascade'),
    foreignKey({
      columns: [columns['pagesID']],
      foreignColumns: [pages.id],
      name: 'mega_menu_rels_pages_fk',
    }).onDelete('cascade'),
    foreignKey({
      columns: [columns['postsID']],
      foreignColumns: [posts.id],
      name: 'mega_menu_rels_posts_fk',
    }).onDelete('cascade'),
  ],
)
...
export const social_media_links = pgTable(
  ...
  (columns) => [
    index('social_media_links_order_idx').on(columns._order),
    index('social_media_links_parent_id_idx').on(columns._parentID),
    foreignKey({
      columns: [columns['_parentID']],
...
export const relations_pages_blocks_content_rows = relations(
  pages_blocks_content_rows,
  ({ one }) => ({
    _parentID: one(pages_blocks_content, {
      fields: [pages_blocks_content_rows._parentID],
      references: [pages_blocks_content.id],
      relationName: 'rows',
    }),
  }),
...
export const relations_pages_blocks_content = relations(pages_blocks_content, ({ one, many }) => ({
  ...
  rows: many(pages_blocks_content_rows, {
    relationName: 'rows',
  }),
}))
...
export const relations__pages_v_blocks_content_rows = relations(
  _pages_v_blocks_content_rows,
  ({ one }) => ({
    _parentID: one(_pages_v_blocks_content, {
      fields: [_pages_v_blocks_content_rows._parentID],
      references: [_pages_v_blocks_content.id],
      relationName: 'rows',
    }),
  }),
...
export const relations__pages_v_blocks_content = relations(
  ...
  ({ one, many }) => ({
    ...
    rows: many(_pages_v_blocks_content_rows, {
      relationName: 'rows',
    }),
  }),
)
...
export const relations_mega_menu_nav_items = relations(mega_menu_nav_items, ({ one }) => ({
  _parentID: one(mega_menu, {
    fields: [mega_menu_nav_items._parentID],
    references: [mega_menu.id],
    relationName: 'navItems',
  }),
}))
export const relations_mega_menu_rels = relations(mega_menu_rels, ({ one }) => ({
  parent: one(mega_menu, {
    fields: [mega_menu_rels.parent],
    references: [mega_menu.id],
    relationName: '_rels',
  }),
  pagesID: one(pages, {
    fields: [mega_menu_rels.pagesID],
    references: [pages.id],
    relationName: 'pages',
  }),
  postsID: one(posts, {
    fields: [mega_menu_rels.postsID],
    references: [posts.id],
    relationName: 'posts',
  }),
}))
export const relations_mega_menu = relations(mega_menu, ({ many }) => ({
  navItems: many(mega_menu_nav_items, {
    relationName: 'navItems',
  }),
  _rels: many(mega_menu_rels, {
    relationName: '_rels',
  }),
}))
...
type DatabaseSchema = {
  ...
  enum_pages_blocks_content_columns_accent_line_alignment: typeof enum_pages_blocks_content_columns_accent_line_alignment
  ...
  enum_pages_blocks_content_rows_padding_top: typeof enum_pages_blocks_content_rows_padding_top
  enum_pages_blocks_content_rows_padding_bottom: typeof enum_pages_blocks_content_rows_padding_bottom
  ...
  enum__pages_v_blocks_content_columns_alignment: typeof enum__pages_v_blocks_content_columns_alignment
  enum__pages_v_blocks_content_columns_accent_line_alignment: typeof enum__pages_v_blocks_content_columns_accent_line_alignment
  ...
  enum__pages_v_blocks_content_rows_padding_top: typeof enum__pages_v_blocks_content_rows_padding_top
  enum__pages_v_blocks_content_rows_padding_bottom: typeof enum__pages_v_blocks_content_rows_padding_bottom
  ...
  enum_mega_menu_nav_items_link_type: typeof enum_mega_menu_nav_items_link_type
  ...
  pages_blocks_content_rows: typeof pages_blocks_content_rows
  ...
  _pages_v_blocks_content_rows: typeof _pages_v_blocks_content_rows
  ...
  mega_menu_nav_items: typeof mega_menu_nav_items
  mega_menu: typeof mega_menu
  mega_menu_rels: typeof mega_menu_rels
  ...
  relations_pages_blocks_content_rows: typeof relations_pages_blocks_content_rows
  ...
  relations__pages_v_blocks_content_rows: typeof relations__pages_v_blocks_content_rows
  ...
  relations_mega_menu_nav_items: typeof relations_mega_menu_nav_items
  relations_mega_menu_rels: typeof relations_mega_menu_rels
