...
import CodeBlipButton from '../CodeBlip/Button'
...
const Code: React.FC<Props> = (props) => {
  ...
  const getCodeBlip = useCallback(
    (rowNumber: number) => {
      ...
      return (codeBlips as any[]).find((blip: any) => blip.row === rowNumber) ?? null
    },
    [codeBlips],
  )
                  ...
                  <div {...lineProps} key={i}>
                    <>
                      ...
                      <div className={classes.lineCodeWrapper}>
                        ...
                        {codeBlip ? <CodeBlipButton blip={codeBlip} index={blipCounter} /> : null}
                      </div>
                    </>
                  </div>
                )
