...
import { CMSLink, type Reference } from '@/components/CMSLink'
import type { DefaultNodeTypes, SerializedBlockNode } from '@payloadcms/richtext-lexical'
import type { SerializedLexicalNode } from '@payloadcms/richtext-lexical/lexical'
import type { SerializedLabelNode } from '@/fields/richText/features/label/LabelNode'
...
type CommandLineBlock = any
type VideoBlock = any
type VideoDrawerBlock = any
type YoutubeBlock = any
type BrBlock = any
type ResourceBlock = any
type SpotlightBlock = any
type UploadBlock = any
type Doc = any
...
import { getVideo } from '@/utilities/get-video'
...
import { LightDarkImage, type LightDarkImageBlock } from './LightDarkImage/index'
...
import { type RestExamplesBlock } from './RestExamples/types'
import { CustomTableJSXConverters } from './Table/index'
import { TableWithDrawers } from './TableWithDrawers'
import type { TableWithDrawersBlock } from './TableWithDrawers/index'
import type { TemplateCardsBlock } from '@/components/TemplateCardsBlock/index'
...
export const jsxConverters: (args: { toc?: boolean }) => JSXConvertersFunction<NodeTypes> =
  ...
  ({ defaultConverters }) => {
    const converters: JSXConverters<NodeTypes> = {
      ...
      blocks: {
        Banner: ({ node }) => {
          return <Banner content={node.fields.content} style={node.fields.style} />
        },
        br: () => <br />,
        Code: ({ node }) => {
